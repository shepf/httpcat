...
```
release/
├── httpcat_v0.2.1_linux-amd64.tar.gz    # Linux x86_64 安装包
├── httpcat_v0.2.1_linux-arm64.tar.gz    # Linux ARM64 安装包
├── httpcat_v0.2.1_darwin-arm64.tar.gz   # macOS Apple Silicon 安装包
└── httpcat_v0.2.1_windows-amd64.zip     # Windows 安装包
```
...
```bash
# 解压安装包
tar -xzf httpcat_v0.2.1_linux-amd64.tar.gz
...
```bash
./httpcat -v
# 输出: httpcat version v0.2.1 (build: 202401311200, commit: abc1234)
```
